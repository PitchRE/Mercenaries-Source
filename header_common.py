...
multiplayer_event_admin_set_disallow_granades                 = 48
multiplayer_event_other_events                                = 49

#other client events
multiplayer_event_other_event_set_bot_purchase                = 0
multiplayer_event_other_admin_set_team_ratio                  = 1
multiplayer_event_other_admin_set_squad_size                  = 2
multiplayer_event_other_event_ccoop_count_down_visible		  = 3
multiplayer_event_other_event_ccoop_count_down_invisible	  = 4
#multiplayer_event_other_event_ccoop_map_change				  = 5
...
multiplayer_event_other_admin_enable_cbf_squad_ratio 		  = 13
multiplayer_event_other_event_set_squad_size_calc			  = 14
...
multiplayer_event_return_set_bot_selection                    = 107 
multiplayer_event_return_team_ratio                           = 108
multiplayer_event_return_squad_size                           = 109
multiplayer_event_return_server_mission_timer_while_player_joined = 110
multiplayer_event_show_duel_request                           = 111
multiplayer_event_start_duel                                  = 112
multiplayer_event_cancel_duel                                 = 113
multiplayer_event_show_server_message                         = 114
multiplayer_event_return_disallow_ranged_weapons              = 115
...
# 127 = max! still free:  49  117-127   Possibilty to merge some when needed more events.. would require a client side patch.


#Illuminati
multiplayer_event_display_information_message = 125
multiplayer_event_display_important_message = 126
multiplayer_event_pass_troop_data = 127
...
multiplayer_game_type_captain_team_deathmatch = 7
multiplayer_game_type_captain_siege           = -1 
multiplayer_game_type_captain_coop            = 8
multiplayer_game_type_captain_battle		  = 9
multiplayer_num_game_types                    = 10 # captain_coop and battle are restored
...
multi_data_destruc_scene_props_begin = multi_data_ccoop_wave_spawn_data_end+1
multi_data_destruc_scene_props_end = multi_data_destruc_scene_props_begin + 14
multi_data_player_index_list_begin = multi_data_destruc_scene_props_end
...
multi_item_class_type_throwing = 15
multi_item_class_type_bolt = 16
