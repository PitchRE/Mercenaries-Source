...
meshes = [
  ...
  ("pic_pergament", 0, "pic_pergament", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_tavern", 0, "pic_tavern", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_pol_army", 0, "pic_pol_army", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_kozak_army", 0, "pic_kozak_army", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_books", 0, "pic_books", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_moscow_army", 0, "pic_moscow_army", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_swed_army", 0, "pic_swed_army", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_village_u", 0, "pic_village_u", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  #("mp_ui_host_maps_2", 0, "mp_ui_host_maps_a2", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_monastery", 0, "mp_ui_host_maps_monastery", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_vyborg", 0, "mp_ui_host_maps_vyborg", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_nomad_camp", 0, "mp_ui_host_maps_nomad_camp", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_hill_castle", 0, "mp_ui_host_maps_hill_castle", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_oreshek", 0, "mp_ui_host_maps_oreshek", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_marketplace", 0, "mp_ui_host_maps_marketplace", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_river_village", 0, "mp_ui_host_maps_river_village", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_old_castle", 0, "mp_ui_host_maps_old_castle", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_arena", 0, "mp_ui_host_maps_arena", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_swamp_delta", 0, "mp_ui_host_maps_swamp_delta", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_fields", 0, "mp_ui_host_maps_fields", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_hillroad", 0, "mp_ui_host_maps_hillroad", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_forest_edge", 0, "mp_ui_host_maps_forest_edge", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_forest_road", 0, "mp_ui_host_maps_forest_road", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("mp_ui_host_maps_steppe_farmstead", 0, "mp_ui_host_maps_steppe_farmstead", 0, 0, 0, 0, 0, 0, 1, 1, 1),
#new
  ("flag_project_rb", 0, "flag_project_rb", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("flag_project_rb_miss", 0, "flag_project_rb_miss", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("incoming_enemy", 0, "incoming_enemy", 0, 0, 0, 0, 0, 0, 2, 2, 2),
  ("prison_cart_pos", 0, "prison_cart_pos", 0, 0, 0, 0, 0, 0, 2, 2, 2),
