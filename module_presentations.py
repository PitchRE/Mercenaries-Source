  ...
  ("game_multiplayer_admin_panel", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
	  ...
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_swed_zamok"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_vyborg"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_nomad_camp"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_nomad_camp"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_forest_road"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_forest_road"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_river_village"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_river_village"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_forest_edge"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_forest_edge"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_arena"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_arena"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_hillroad"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_hillroad"),
	  (else_try), 
	  ...
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_old_castle"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_old_castle"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_mosk_monastyr"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_monastery"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_novgorod_fortress"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_hill_castle"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_rus_fortress"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_oreshek"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_polya"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_fields"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_hutor"), 
		(assign, ":map_image", "mesh_mp_ui_host_maps_steppe_farmstead"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_new_1"),
		(assign, ":map_image", "mesh_mp_ui_host_maps_19"),
	  (else_try), 
	    (eq, "$g_multiplayer_selected_map", "scn_mp_new_2"),
      ...
      (assign, ":cur_y", 1200),
      (assign, ":cur_y_adder", 40),
      (val_add, ":cur_y", ":cur_y_adder"), #one more option for all modes
      ...
      (try_for_range, ":i_map", 0, ":num_maps"),
		...
		(try_begin),
		  (is_between, ":map_no", multiplayer_scenes_begin, multiplayer_scenes_end),
          (store_sub, ":string_index", ":map_no", multiplayer_scenes_begin),
          (val_add, ":string_index", multiplayer_scene_names_begin),
		(else_try),
          (store_sub, ":string_index", ":map_no", multiplayer_new_scenes_begin),
	  ...
	  (try_begin),
		  (eq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
		  (create_number_box_overlay, "$g_presentation_obj_admin_panel_21", 2, 9), # range is [2,8] for ccoop
      ...
      (server_get_max_num_players, ":max_num_players"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_21", ":max_num_players"),
	  ...
	  (try_begin), 
		...
		(try_begin),
		  (eq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
		  #(create_number_box_overlay, "$g_presentation_obj_admin_panel_3", 6, 7), # fixed squad size is 6 for ccoop
		  (assign, "$g_multiplayer_squad_size", 6),
		(else_try),
		  (create_number_box_overlay, "$g_presentation_obj_admin_panel_3", 0, 25), # default max squad size is 24
		(try_end),
        ...
        (overlay_set_val, "$g_presentation_obj_admin_panel_3", "$g_multiplayer_squad_size"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        ...
        (create_text_overlay, reg0, "str_squad_size_for_captains", 0),
        (position_set_x, pos1, 0),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
	  (end_try), 	  
	  ...
	  (try_begin),
		...
		(val_sub, ":cur_y", ":cur_y_adder"),
        (create_number_box_overlay, "$g_presentation_obj_admin_panel_42", 1, 25),
        (overlay_set_val, "$g_presentation_obj_admin_panel_42", "$g_multiplayer_team_ratio"),
        (position_set_x, pos1, 800),
        (position_set_y, pos1, 800),
        (overlay_set_size, "$g_presentation_obj_admin_panel_42", pos1),
        (position_set_x, pos1, 425),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_admin_panel_42", pos1),
        (create_text_overlay, reg0, "str_captain_merc_ratio", 0),
        (position_set_x, pos1, 0),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (create_text_overlay, reg0, "str_1_div", 0),
        (position_set_x, pos1, 390),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
		
		(val_sub, ":cur_y", ":cur_y_adder"),
        (create_text_overlay, reg0, "str_mp_cbf_squad_auto_ratio", 0),
		(position_set_x, pos1, 30),
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, reg0, pos1),
		...
		(overlay_set_val, "$g_presentation_obj_admin_panel_45", "$g_multiplayer_cbf_enable_squad_ratio"),		
		
	  (else_try),
		(neq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop), 
		(neq, "$g_multiplayer_game_type", multiplayer_game_type_captain_siege), 
		(neq, "$g_multiplayer_game_type", multiplayer_game_type_captain_team_deathmatch),
...
##        (this_or_next|eq, "$g_multiplayer_game_type", multiplayer_game_type_destroy),
      ...
      (overlay_set_val, "$g_presentation_obj_admin_panel_43", "$g_multiplayer_disallow_ranged_weapons"),

      (val_sub, ":cur_y", ":cur_y_adder"),
	  
      (create_text_overlay, reg0, "str_multi_disable_granades", 0),
      (position_set_x, pos1, 30),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (overlay_set_val, "$g_presentation_obj_admin_panel_44", "$g_multiplayer_disallow_granades"),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
		...
		(try_begin),			
			(eq, "$g_multiplayer_is_game_type_captain", 1),
			(multiplayer_send_2_int_to_server, multiplayer_event_other_events, multiplayer_event_other_admin_set_squad_size, ":value"),			
		(else_try),			
      ...
      (else_try),
		...
		(try_begin),
			...
			(else_try),	
				(neq, "$g_multiplayer_game_type", multiplayer_game_type_captain_battle),			
				(tutorial_message, "str_warning_max_players_count_text"), 
			(end_try), 
		(end_try), 
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_game_multiplayer_admin_panel"),
...
##        (try_end),
      ...
      (else_try),
        ...
        (multiplayer_send_2_int_to_server, multiplayer_event_other_events, multiplayer_event_other_admin_set_team_ratio, ":value"),
      (else_try),
      ...
      (else_try),
        ...
        (multiplayer_send_int_to_server, multiplayer_event_admin_set_disallow_granades, ":value"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_45"),
        (multiplayer_send_2_int_to_server, multiplayer_event_other_events, multiplayer_event_other_admin_enable_cbf_squad_ratio, ":value"),
      (try_end),
      ]),
    (ti_on_presentation_run,
     [
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (overlay_set_hilight_color, "$g_presentation_obj_team_select_1", 0x6D001F),
	  ...
	  (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (overlay_set_hilight_color, "$g_presentation_obj_team_select_2", 0x6D001F),
          (try_end),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_end),
        (else_try),
          (ge, "$g_presentation_obj_team_select_2", 0),
     ...
     [(store_trigger_param_1, ":object"),
      ...
      (try_for_range, ":i_button", multi_data_troop_button_indices_begin, ":end_cond"),
        ...
        (try_begin),
		  ...
		  (call_script, "script_mp_set_player_troop_id", ":my_player_no", ":selected_troop_no", 1),
        (try_end),
        (presentation_set_duration, 0),
    ...
    (ti_on_presentation_load,
      [(set_fixed_point_multiplier, 1000),
        ...
        (try_begin),
          ...
          #MCA mp captain modes
          (try_begin),
            (eq, "$g_multiplayer_is_game_type_captain", 1),
            
            # Squad Label
            (create_text_overlay, "$g_presentation_obj_item_select_23", "str_mp_squad", 0),
            (overlay_set_color, "$g_presentation_obj_item_select_23", 0xFFFFFF),
            (position_set_x, pos1, 460),
            (position_set_y, pos1, 715),
            (overlay_set_position, "$g_presentation_obj_item_select_23", pos1),
            
            # Squad Add/Remove Button
            (create_in_game_button_overlay, "$g_presentation_obj_item_select_19", "str_mp_add_troop"),
            (position_set_x, pos1, 500),
            (position_set_y, pos1, 610),
            (overlay_set_position, "$g_presentation_obj_item_select_19", pos1),
            
            # Requested Squad Size
            (assign, ":temp_reg0", reg0),
            (call_script, "script_multiplayer_get_requested_squad_count", ":my_player_no"),
            (create_text_overlay, "$g_presentation_obj_item_select_20", "str_mp_squad_req_size_reg0"),
            (assign, reg0, ":temp_reg0"),
            (overlay_set_color, "$g_presentation_obj_item_select_20", 0xFFFFFF),
            (position_set_x, pos1, 420),
            (position_set_y, pos1, 685),
            (overlay_set_position, "$g_presentation_obj_item_select_20", pos1),
            
            # Active Squad Size
            (create_text_overlay, reg1, "str_mp_squad_active_size_reg0"),
            (call_script, "script_mp_get_player_total_alive_troop_count", ":my_player_no"),
            (overlay_set_text, reg1, "str_mp_squad_active_size_reg0"),
            (overlay_set_color, reg1, 0xFFFFFF),
            (position_set_x, pos1, 420),
            (position_set_y, pos1, 660),
            (overlay_set_position, reg1, pos1),
            
            (create_text_overlay, "$g_presentation_obj_item_select_21", "str_squad_cost_reg0", tf_left_align|tf_single_line|tf_with_outline),
            (position_set_x, pos1, 670),
            (position_set_y, pos1, 667),
            (overlay_set_position, "$g_presentation_obj_item_select_21", pos1),
            
            (create_text_overlay, "$g_presentation_obj_item_select_22", "str_item_cost_reg0", tf_left_align|tf_single_line|tf_with_outline),
            (position_set_x, pos1, 670),
            (position_set_y, pos1, 692),
            (overlay_set_position, "$g_presentation_obj_item_select_22", pos1),
          (else_try),
        ...
        # $g_presentation_obj_item_select_next should be assigned to the last created control plus one
        (try_begin),
          (call_script, "script_cf_multiplayer_can_buy_squad"),
          (store_add, "$g_presentation_obj_item_select_next", "$g_presentation_obj_item_select_22", 2), # since captain mode has more ui controls
        (else_try),
      ...
      [(store_trigger_param_1, ":object"),
        ...
        (try_begin),
          ...
          (try_begin),
            (eq, ":enter_leave", 0),			
            (try_begin),
              (is_between, ":object", "$g_multiplayer_troop_selection_begin", "$g_multiplayer_troop_selection_end"),
              (store_sub, ":selected_troop", ":object", "$g_multiplayer_troop_selection_begin"),
              (val_div, ":selected_troop", 2),
              
              (multiplayer_get_my_player, ":my_player_no"),
              (player_get_troop_id, ":my_player_troop_no", ":my_player_no"),
              (store_troop_faction, ":my_faction_no", ":my_player_troop_no"),
              (try_for_range, ":troop_array_index", 0, 2),
                ...
                (try_for_range, ":cur_troop", ":troop_array_begin", ":troop_array_end"),
                  ...
                  (try_begin),
                    (eq, ":my_faction_no", ":trp_faction"),
                    (val_sub, ":selected_troop", 1),
                    (lt, ":selected_troop", 0),
                    (assign, "$g_current_opened_item_details", ":cur_troop"),
                    (troop_get_slot,  ":cur_troop_cost", ":cur_troop", slot_troop_mp_squad_price),
                    (overlay_get_position, pos1, ":object"),
                    (show_troop_details, ":cur_troop", pos1, ":cur_troop_cost"),
                  (try_end),
                (try_end),
              (try_end),
            (try_end),
              ...
              (try_for_range, ":troop_array_index", 0, 2),
                ...
                (try_for_range, ":cur_troop", ":troop_array_begin", ":troop_array_end"),
                  ...
                  (try_begin),
                    ...
                    (lt, ":selected_troop", 0),
                    (try_begin),
                      (eq, "$g_current_opened_item_details", ":cur_troop"),
                      (close_item_details),
                      (assign, "$g_current_opened_item_details", -1),
                    (try_end),
                  (try_end),
      ...
      [(store_trigger_param_1, ":object"),
        ...
        (try_begin),
          ...
          (else_try),
            ...
            (try_begin),
              # close troop panel if anything except troop buttons is left clicked
              (neg|is_between, ":object", "$g_multiplayer_troop_selection_begin", "$g_multiplayer_troop_selection_end"),
              (presentation_set_duration, 0),
              (assign, "$g_presentation_state", 0),
              (start_presentation, "prsnt_multiplayer_item_select"),
            (try_end),
          ...
          (try_begin),
            ...
            (call_script, "script_multiplayer_set_default_item_selections_for_troop", ":my_player_no", ":my_troop_no"),
			(call_script, "script_multiplayer_reset_squad_on_team_change_for_captain_game_types", ":my_player_no"),
            (presentation_set_duration, 0),
            (assign, "$g_presentation_state", 0),
            (start_presentation, "prsnt_multiplayer_item_select"),
          (else_try),
          ...
          (else_try),
            ...
            (assign, ":add_count", 1),
            # add 5 units if control or shift is pressed
            (try_begin),
			...
			(call_script, "script_mp_get_troop_with_squad_index_for_player", ":my_player_no", ":selected_troop"),
			(assign, ":selected_troop_id", reg0),
						
			(try_begin),
				(eq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
				(lt, "$g_multiplayer_ccoop_wave_no", 10),
				(store_character_level, ":troop_level", ":selected_troop_id"),
				(store_sub, ":level", ":troop_level", 1),
				(val_div, ":level", 5),
				
				(store_sub, ":wave_level", "$g_multiplayer_ccoop_wave_no", 1),
				(val_div, ":wave_level", 3),
				(val_add, ":wave_level", 1),
				
				(lt, ":level", ":wave_level"),
				(call_script, "script_mp_add_troop", ":selected_troop_id", ":my_player_no", ":add_count"),
				# reg0 contains max troop count
				(call_script, "script_multiplayer_update_troop_max_number", ":selected_troop", reg0),
				(call_script, "script_multiplayer_update_cost_labels"),
			(else_try),
				(eq, "$g_multiplayer_game_type", multiplayer_game_type_captain_coop),
				(ge, "$g_multiplayer_ccoop_wave_no", 10),
				(call_script, "script_mp_add_troop", ":selected_troop_id", ":my_player_no", ":add_count"),
				# reg0 contains max troop count
				(call_script, "script_multiplayer_update_troop_max_number", ":selected_troop", reg0),
				(call_script, "script_multiplayer_update_cost_labels"),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (else_try),
              (eq, "$g_presentation_state", 10), # if squad panel is open
              (try_begin),
			    (store_sub, ":overlay_end", "$g_multiplayer_troop_selection_end", "$g_multiplayer_troop_selection_begin"),
				(val_add, ":overlay_end", "$g_multiplayer_troop_selection_end"),
				(val_add, ":overlay_end", "$g_multiplayer_troop_selection_end"),
                (is_between, ":object", "$g_multiplayer_troop_selection_begin", ":overlay_end"),
				(try_begin),
				  (is_between, ":object", "$g_multiplayer_troop_selection_begin", "$g_multiplayer_troop_selection_end"),
                  (assign, reg0, ":object"),
                  (val_mod, reg0, 2),
                  ...
                  #revani: This is necessary for multiplayer_game_type_captain_battle, do not comment it out.
                  (multiplayer_get_my_player, ":my_player_no"),
                  
                  (store_sub, ":selected_troop", ":object", "$g_multiplayer_troop_selection_begin"),
                  (val_div, ":selected_troop", 2),
                  
                  (assign, ":remove_count", -1),
                  # remove 5 units if control or shift is pressed
                  (try_begin),
                    (this_or_next|key_is_down, key_left_shift),
                    (this_or_next|key_is_down, key_right_shift),
                    (this_or_next|key_is_down, key_left_control),
                    (key_is_down, key_right_control),
                    (assign, ":remove_count", -5),
                  (try_end),
				  
				  (call_script, "script_mp_get_troop_with_squad_index_for_player", ":my_player_no", ":selected_troop"),
			      (assign, ":selected_troop_id", reg0),
				  (call_script, "script_mp_add_troop", ":selected_troop_id", ":my_player_no", ":remove_count"),
				  # reg0 contains max troop count
				  (call_script, "script_multiplayer_update_troop_max_number", ":selected_troop", reg0),
				  (call_script, "script_multiplayer_update_cost_labels"),
                (try_end),
...
##        (overlay_set_text, "$g_multiplayer_team_2_score_display_overlay", "str_s0_dd_reg0"),
  ...
  ("multiplayer_destructible_targets_display", prsntf_read_only|prsntf_manual_end_only, 0, [ #this is for search and destroy death mode flags.
    ...
    (ti_on_presentation_run, [
      ...
      (try_begin),            
		...
		(else_try),
		  (le, "$g_multiplayer_ccoop_wave_no", 20),
		  (str_store_string, s0, "str_ccoop_veteran_wave_reg1_is_coming_in_reg0_seconds"),
		  (try_begin),
		    (gt, "$g_multiplayer_ccoop_wave_no", 10),
		    (lt, "$g_multiplayer_ccoop_wave_no", 14),
		    (str_store_string, s1, "str_veteran_wave_hint"),
		  (try_end),
		(else_try),
		  (str_store_string, s0, "str_ccoop_elite_wave_reg1_is_coming_in_reg0_seconds"),
		  (try_begin),
		    (gt, "$g_multiplayer_ccoop_wave_no", 20),
		    (lt, "$g_multiplayer_ccoop_wave_no", 24),
	...
	#MCA: ccoop change map counter presentation 
	
	#("multiplayer_ccoop_change_map_time_counter", prsntf_read_only|prsntf_manual_end_only, 0, [
    #(ti_on_presentation_load, [      
    #  (set_fixed_point_multiplier, 1000),
    #
    #  (assign, "$g_multiplayer_respawn_counter_overlay", -1),
    ...
    #  (ge, "$g_multiplayer_respawn_counter_overlay", 0),      
    #  (store_mission_timer_a, ":current_time"),
    #  (store_sub, ":seconds_left", "$g_multiplayer_ccoop_next_wave_start_time", ":current_time"),
    #  (try_begin),            
    #    (lt, ":seconds_left", 1),
    #    (presentation_set_duration, 0),
	#	
	#	(try_begin),
	#		(multiplayer_is_server), #MCA: change to dedicated!
	#		(call_script, "script_mp_ccoop_change_map"),
	#	(try_end),
    #  (else_try),
    #    (assign, reg0, ":seconds_left"),		
    #    (str_store_string, s0, "str_ccoop_change_map_in_reg0_seconds"),		
    #    (overlay_set_text, "$g_multiplayer_respawn_counter_overlay", s0),
    #  (try_end),        
    #  ]),
    #]),
  ...
  #this score table is used in only deathmatch (also in captain coop)
  ("multiplayer_stats_chart_deathmatch", prsntf_read_only|prsntf_manual_end_only, 0, [ 
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (store_add, ":total_rows", ":team_rows", ":spectator_rows"),#TODO SARI
	  ...
	  (try_begin),
		...
		(try_begin),
		  ...
		  (else_try),
		    (le, "$g_multiplayer_ccoop_wave_no", 20),
		    (create_text_overlay, reg0, "str_veteran_wave_no_reg1", 0),
		  (else_try),
		...
		(try_begin),
            #(le, "$g_multiplayer_ccoop_enemy_respawn_secs", multi_captain_coop_round_duration_in_sec),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$g_presentation_obj_escape_menu_6", -1),
       (assign, "$g_presentation_obj_reload", -1),
      ...
      (try_begin),
        ...
        (create_button_overlay, "$g_presentation_obj_reload", "@Reload Character", 0),
        (overlay_set_color, "$g_presentation_obj_reload", 0x008000),
        (assign, "$g_presentation_obj_reload_available", 1),
        (try_begin),
          (ge, ":my_player_no", 0),
          (player_get_slot, ":last_poll_time", ":my_player_no", slot_player_reload_disabled_until_time),
          (store_mission_timer_a, ":mission_timer"),
          (lt, ":mission_timer", ":last_poll_time"),
          (overlay_set_color, "$g_presentation_obj_reload", 0x888888),
          (overlay_set_hilight_color, "$g_presentation_obj_escape_menu_6", 0x888888),
          (assign, "$g_presentation_obj_reload_available", 0),
        (try_end),
      (try_end),
      ...
      (try_begin),
        (ge, "$g_presentation_obj_reload", 0),
        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_obj_reload", pos1),
      (try_end),
    ...
    #    (start_presentation, "prsnt_multiplayer_troop_select"),
      ...
      (else_try),
        ...
        (start_presentation, "prsnt_multiplayer_poll_menu"),
             (else_try),
        (eq, ":object", "$g_presentation_obj_reload"),
        (eq, "$g_presentation_obj_reload_available", 1),
        (presentation_set_duration, 0),
         (store_mission_timer_a, ":mission_timer"),
            (val_add, ":mission_timer", multiplayer_reload_disable_period),
            (multiplayer_get_my_player, ":my_player_no"),
            (player_set_slot, ":my_player_no", slot_player_reload_disabled_until_time, ":mission_timer"),
                       (multiplayer_send_int_to_server, multiplayer_event_data_server, 3),
        (display_message, "@Reloaded your character", 0x008000),
      (else_try),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
		...
		(try_begin),
		  (is_between, "$g_multiplayer_poll_value_to_show", multiplayer_scenes_begin, multiplayer_scenes_end),
          (store_sub, ":string_index", "$g_multiplayer_poll_value_to_show", multiplayer_scenes_begin),
          (val_add, ":string_index", multiplayer_scene_names_begin),
		(else_try),
          (store_sub, ":string_index", "$g_multiplayer_poll_value_to_show", multiplayer_new_scenes_begin),
          (val_add, ":string_index", multiplayer_new_scene_names_begin),
		(try_end),
        (str_store_string, s0, ":string_index"),
          ...
          (try_for_range_backwards, ":loop_var", "trp_kingdom_heroes_including_player_begin", kingdom_heroes_end),
            ...
            (else_try),
              ...
              (try_begin),
				...
				(store_troop_faction, ":faction", "$g_presentation_marshall_selection_max_renown_1_troop"), 
...
##        (overlay_set_color, reg1, 0),
  ...
  ("oim_prsnt_checker", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      (create_mesh_overlay, reg0, "mesh_mp_ui_host_maps_14"),
      (position_set_x, pos1, -1),
      (position_set_y, pos1, 550),
      (overlay_set_position, reg0, pos1),
      (position_set_x, pos1, 1002),
  ...
  ("tw_show_mouse_movement",prsntf_read_only|prsntf_manual_end_only,0,[
      (ti_on_presentation_load,
       [
         (try_begin),
           (set_fixed_point_multiplier, 1000),
		   (try_for_range, ":cur_dir", 0, 4), 
			  (store_add, ":arrow_mesh", "mesh_mouse_arrow_down", ":cur_dir"),
			  (create_mesh_overlay, reg0, ":arrow_mesh"),
			  (store_mul, ":shift", 220, ":cur_dir"), 
			  (val_add, ":shift", -360), 
			  (position_set_x, pos1, 800),
			  (position_set_y, pos1, 800),
			  (overlay_set_size, reg0, pos1),
			  (store_add, ":x_pos", ":shift", 380),
			  (position_set_x, pos1, ":x_pos"),
			  (position_set_y, pos1, 150),
			  (overlay_set_position, reg0, pos1),
			  (create_mesh_overlay, reg0, "mesh_mouse_left_click"),
...
("whistle", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
...
("warcry", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
          (multiplayer_get_my_player, ":player_no"),
     (player_is_active, ":player_no"),
    ...
    ("stronger_effect", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
     (multiplayer_get_my_player, ":player_no"),
     (player_is_active, ":player_no"),
     ...
     (agent_is_alive, ":agent_no"),
       (assign, reg10, "$g_warcry_active_time"),
        (gt, "$g_warcry_active_time", 0),
      (try_begin),
      (create_text_overlay, reg0, "@ Stronger: {reg10}"),
      (overlay_set_color, reg0, 0xFFFFFF),
      ...
      (try_end),
      (try_begin),
      (create_mesh_overlay, reg0, "mesh_effect_stronger"),
