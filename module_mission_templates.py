...
#used for torunament master scene
  ...
  (
   ...
   (
    ...
    (player_get_unique_id, reg4, ":player_no"),
        (display_message, "@Hello {reg4}"),
        ]),
	 ...
	 #Illuminati
        ...
        (agent_get_wielded_item, ":weapon_id", ":killer_agent_no"),
		 ...
		 (try_begin),
			...
			(player_get_slot, ":this_round_kills", ":player_id", slot_player_this_round_kills),
			(val_add, ":this_round_kills", 1),
			(player_set_slot, ":player_id", slot_player_this_round_kills, ":this_round_kills"),
           ...
           (try_begin),         
             ...
             (call_script, "script_show_multiplayer_message", multiplayer_message_type_round_result_in_battle_mode, "$g_winner_team"),
			   ...
			   (try_for_range, ":cur_player", 0, ":max_players"),
					...
					(player_get_slot, ":this_round_points", ":cur_player", slot_player_this_round_points),
					(try_begin),
						(eq, ":cur_team", "$g_winner_team"),
						(val_add, ":this_round_points", 2),
					(else_try),
						(val_add, ":this_round_points", 1),
					(try_end),
					(player_set_slot, ":cur_player", slot_player_this_round_points, ":this_round_points"),
			   (try_end),
			   (try_for_range, ":cur_player", 0, ":max_players"),
					(player_is_active, ":cur_player"),
