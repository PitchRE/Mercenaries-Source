...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3], 
 ...
 ["fall_chest_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [3.6, "death_impact_front_fall_forwards_02", 0, 57, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 0.4],  # 1.6],
   [1.4, "death_impact_front_fall_backwards_01", 0, 51, arf_blend_in_16|arf_make_custom_sound, pack2f(0.25, 0.0), (0,0,0), 0.4],
   [1.6, "death_impact_front_fall_backwards_02", 0, 61, arf_blend_in_16|arf_make_custom_sound, pack2f(0.25, 0.0), (0,0,0), 0.4],
 ],
 ["fall_abdomen_hold_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [4.4, "death_impact_front_fall_forwards_01", 7, 110, arf_blend_in_16|arf_make_custom_sound, pack2f(0.7, 0.0), (0,0,0), 4.0],  # 1.8],
 ],
 ...
 ["fall_right_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.0, "death_impact_front_fall_right_back_01", 0, 53, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 1.0],
 ],
 ["fall_body_back", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.2, "death_impact_back_fall_left_01", 0, 62, arf_blend_in_16|arf_make_custom_sound, pack2f(0.7, 0.0), (0,0,0), 1.8],
   [2.6, "death_impact_back_fall_right_01", 0, 70, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 1.6],
 ],
